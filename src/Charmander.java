/**
 * Function pokemon Charmander - overrides the specialFight from Pokemon class and uses the special moves given
...
public class Charmander extends Pokemon implements Fire {
	 ...
	 */
	public Charmander(String name, int level, int hp) {
		super(name, level, hp);
	}
