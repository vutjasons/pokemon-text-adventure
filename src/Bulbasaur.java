/**
 * Function pokemon Bulbasaur - overrides the specialFight from Pokemon class and uses the special moves given
...
public class Bulbasaur extends Pokemon implements Grass {
	 ...
	 */
	public Bulbasaur(String name, int level, int hp) {
		super(name, level, hp);
	}
	...
	public int specialFight(int move) {
		...
		if(move == 1)
		{
			...
			System.out.println("Bulbasaur grunted and used Vine Whip!");
			return fightDamage;
		}
		else if(move == 2)
		{
			fightDamage = razorLeaf();
			System.out.println("Bulbasaur used its Razor Leaf!");
			return fightDamage;
		}
		...
		else
		{
			...
			System.out.println("Bulbasaur charged up and used Solar Beam!");
			return fightDamage;
		}
	}
